...
import {
  ...
  ImgPassagerDetails,
  H3PassagerDetails,
  ParrafoPassagerDetails,
  DivFormulario,
  LabelsPassagerDetails,
  ErrorsPassagerDetails,
  DivField,
  StyledField,
  DivFieldSelect,
  DivIdentify,
    ...
    <Formik
      ...
      validate={(values) => {
        ...
        if (!values.pNumber) {
          ...
          errores.pNumber =
            "The passport number can only contain numbers and dashes";
        }
        //name contact
        ...
        if (!values.surnameContact) {
          ...
          errores.surnameContact =
            "The surname can only contain letters and spaces";
        }
        //email
        if (!values.emailContact) {
          ...
          errores.emailContact =
            "email can only have letters, numbers, periods and dashes";
        }
        ...
        if (!values.numberContact) {
          ...
          errores.numberContact =
            "The phone number cannot contain letters or space characters";
        }
        return errores;
      }}
      ...
      {({ errors, values, handleChange }) => (
        <StyledForm>
          <div>
            <TitlePassagerDetails>
              <ImgPassagerDetails
                src="https://res.cloudinary.com/dbktnqag9/image/upload/v1697571091/Sprint2React-Eflight/Frame_vt80ki.png"
                alt="passager"
              />
            ...
            <DivFormulario>
              <DivField>
                <LabelsPassagerDetails htmlFor="name">
                  Name
                </LabelsPassagerDetails>
                <StyledField
                  type="text"
              ...
              <DivField>
                <LabelsPassagerDetails htmlFor="surname">
                  Surname
                </LabelsPassagerDetails>
                <StyledField
                  type="text"
              ...
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="title">
                  Title
                </LabelsPassagerDetails>
                <StyledField
                  id="title"
              ...
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="birthday">
                  Birthday
                </LabelsPassagerDetails>
                <StyledField
                  id="birthday"
              ...
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="nationality">
                  Nationality
                </LabelsPassagerDetails>
                <StyledField
                  id="nationality"
          ...
          <DivIdentify>
            <TitlePassagerDetails>
              <ImgPassagerDetails
                src="https://res.cloudinary.com/dbktnqag9/image/upload/v1697571092/Sprint2React-Eflight/Frame_dbb96o.svg"
                alt="identify"
              />
            ...
            <PIdentify>
              ...
              required for international travel or transit abroad <br />
              <br /> Make sure that the passenger&apos;s name is exactly as
              written in the government issued ID/Passport/Driving License.
              <br /> Avoid any mistake, because some airlines don&apos;t allow
              name corrections after booking.
            </PIdentify>
            <DivFormulario>
              <DivFieldComplete>
                <LabelsPassagerDetails htmlFor="pNumber">
                  Passport number
                </LabelsPassagerDetails>
                <StyledField
                  type="number"
              ...
              <DivField>
                <LabelsPassagerDetails htmlFor="country">
                  Country of Issue
                </LabelsPassagerDetails>
                <StyledField
                  id="country"
              ...
              <DivField>
                <LabelsPassagerDetails htmlFor="expiryDate">
          ...
          <DivContact>
            <TitleContact>
              <ImgPassagerDetails
                src="https://res.cloudinary.com/dbktnqag9/image/upload/v1697571091/Sprint2React-Eflight/Contact_ybghi4.svg"
                alt="contact"
              />
            ...
            <DivFormulario>
              <DivField>
                <LabelsPassagerDetails htmlFor="nameContact">
                  Name
                </LabelsPassagerDetails>
                <StyledField
                  type="text"
              ...
              <DivField>
                <LabelsPassagerDetails htmlFor="surnameContact">
                  Surname
                </LabelsPassagerDetails>
                <StyledField
                  type="text"
                ...
                <ErrorMessage
                  ...
                  component={() => (
                    <ErrorsPassagerDetails>
                      {" "}
                      {errors.surnameContact}
                    </ErrorsPassagerDetails>
                  )}
                />
              </DivField>
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="titleContact">
                  Title
                </LabelsPassagerDetails>
                <StyledField
                  id="titleContact"
              ...
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="emailContact">
                  Email
                </LabelsPassagerDetails>
                <StyledField
                  type="email"
              ...
              <DivFieldSelect>
                <LabelsPassagerDetails htmlFor="numberContact">
                  Phone number
                </LabelsPassagerDetails>
                <StyledField
                  type="number"
